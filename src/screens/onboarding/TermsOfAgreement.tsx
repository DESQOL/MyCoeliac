...
Terms and conditions
                ...
                <View style={styles.flexPlaceHolderTwo} />
...
Welcome to our app. If you continue to browse and use this app, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern MyCoeliac’s relationship with you in relation to this app. If you disagree with any part of these terms and conditions, please do not use our app.
                        </Text>
                        <Text style={styles.tcP}>
The term ‘MyCoeliac’ or ‘us’ or ‘we’ refers to the owner of the app whose registered office is Hogeschool van Amsterdam. The term ‘you’ refers to the user or viewer of our app.
                        </Text>
...
From time to time, this app may also include links to other apps. These links are provided for your convenience to provide further information. They do not signify that we endorse the app(s). We have no responsibility for the content of the linked app(s).
                        ...
                        <Text style={styles.tcL}>
                            {'\u2022'}
                            {' '}
Your use of this app and any dispute arising out of such use of the app is subject to the laws of the European Union.
                        </Text>
                        <Text style={styles.tcP}>
